    ...
    <div className=' hero-bg h-screen w-full '>
      ...
      <div className=" flex justify-center items-center mt-10 mx-3   ">
        <div className=" max-w-md space-y-6  bg-black/60 p-8 w-full rounded-md shadow-md  ">
          <h1 className=" text-2xl font-bold  text-white text-center uppercase "> sign up</h1>
          ...
          <form className='space-y-4 '>
            ...
            <div className="  ">
              <label htmlFor="name" className=' text-gray-300 block font-medium text-sm '> Name </label>
            ...
            <button className=' w-full mt-4 py-2 bg-red-500 hover:bg-red-700 text-white font-semibold rounded-md'> Sign up</button>
          </form>
         
          <div className=" text-center text-gray-400">
            Already a Member?{" "} <Link to={"/login"} className='text-red-700 hover:underline font-semibold '>Login </Link>
          </div>
        </div>
      </div>
    </div>
